...
# 2. DOSYA OKUMA VE NORMALİZASYON
...
# Dinamik Eşik (İlk 200ms)
noise_threshold = np.mean(energies[:int(0.2*fs/hop_len)]) * 1.5

# 4. SES ÇIKTISI ÜRETME (SESSİZLİKLERİ TEMİZLE)
output_signal = []
...
# Subplot 3: VAD Maskesi (Yeşil Alanlar)
...
# Subplot 4: Çıktı Sesi (Sadece Konuşma)
...
# 6. MEDYA OYNATICIYI AÇ VE ANALİZLERİ YAZDIR
...
# Grafiği ekranda tutmak için en önemli satır
plt.show()
